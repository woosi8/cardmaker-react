...
// A컴포넌트 안에서 B컴포넌트를 만드는데 B컴포넌트를 만들기 위한 props의 갯수가 많다면 그리고 그 props들이 A에서 쓰이지 않는다면
// (그러니깐 단순히 B를 만들기 위해서 A에 모든것을 전달하기 보다는 -> 한 클래스 안에서 다른 클래스를 직접 만든다면, 이건 DI 원칙에서 어긋나겠죠?)
